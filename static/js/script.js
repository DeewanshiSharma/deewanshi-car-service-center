...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // CHANGE 1: Fix voice loading (most important!)
    let voices = [];
    ...
    // CHANGE 2: Improved speak() function
    function speak(text) {
    ...
    // CHANGE 3: Remove manual isSpeaking + setTimeout in startAssistant
    function startAssistant() {
        ...
        fetch('/start', { method: 'POST' })
            ...
            .then(data => {
                ...
                // REMOVED: isSpeaking = true; disableMic(); setTimeout(...)
                // Now speak() handles everything perfectly
            });
    }
    ...
    orb.addEventListener('click', () => {
        ...
        recognition.onresult = (e) => {
            ...
            statusText.textContent = "Processing...";
            // REMOVED: isSpeaking = true; disableMic(); (done by speak())
            ...
            .then(data => {
                data.messages.forEach(msg => addMessage('assistant', msg));
                // REMOVED all setTimeout delays - speak() handles timing
            })
            .catch(err => {
